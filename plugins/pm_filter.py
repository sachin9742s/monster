    ...
    if 2 < len(message.text) < 100:    
        ...
        if len(btn) > 10: 
            ...
            if poster:
                ...
                await message.reply_text(f"<b>🎸Check Link At @GD_FILMCLUB🎸..Found... {(len_results)} Results For Your Request 🥰: <code>{query}</code>", ‌‌‌‌‎ ­  ­  ­  ­  ­  </b>", reply_markup=InlineKeyboardMarkup(buttons))
            return
